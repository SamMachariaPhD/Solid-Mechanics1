...
stem:[\Delta L = L \times \alpha \times t] 
...
|1.
|Steel
|stem:[11.5 \times 10^{-6} - 13 \times 10^{-6}]

|2.
|Wrought iron, Cast iron
|stem:[11 \times 10^{-6} - 12 \times 10^{-6}]

|3.
|Aluminium
|stem:[23 \times 10^{-6} - 24 \times 10^{-6}]

|4.
|Copper, Brass, Bronze 
|stem:[17 \times 10^{-6} - 18 \times 10^{-6}]
|===
